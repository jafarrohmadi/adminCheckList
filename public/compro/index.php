...
<html lang="en">
    <head>
        ...
        <!-- Font End -->
        <link type="text/css" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.green.min.css">
            ...
            <div class="wrapper">
                <div class="banner-content">
                    <div class="ri-flex tablet-break">
                        <div class="flex1 ri-paddingright20">
                            <div class="inner-content">
                                  ...
                                  <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            ...
                                            <a href="http://ux.ayooproject.com/ayooaktivasi/login.php" class="_link-default"><h3>Daftar Sekarang</h3></a>
                                        </div>
                                        <div class="swiper-slide">
                                ...
                                <div class="ri-inlineblock new-downloadapp ri-margintop40">
                                    <a href="#"><img src="img/google-play.png" alt="" class="ri-paddingright5"></a>
                        ...
                        <div class="flex1">
                            <img src="img/content-banner.png" alt="" class="phone w-100">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="new-col ri-padding20">
                    <div class="ri-flex tablet-break">
                        <div class="flex1 ri-paddingright20">
                            ...
                            <p>Cukup instruksikan karyawan operasional melalui aplikasi ini, maka penerima tugas akan mendapatkan notifikasi untuk segera menyelesaikan tugasnya.</p>
                        </div>
                        <div class="flex1 ri-right">
                            <img src="img/icons/content1.svg" class="w-100 img-content" alt="">
                        </div>
                    </div>
                </div>
                <div class="new-col ri-padding20">
                    <div class="ri-flex tablet-break">
                        <div class="flex1 ri-paddingright20 push-content ct-right">
                            ...
                            <p>Secara realtime, karyawan operasional dapat langsung melaporkan bukti hasil kerja sebelum dan sesudah dikerjakan kepada pemberi tugas.</p>
                        </div>
                        <div class="flex1 ri-left pull-content">
                            <img src="img/icons/content2.svg" class="w-100 img-content" alt="">
                        </div>
                    </div>
                </div>
                <div class="new-col ri-padding20">
                    <div class="ri-flex tablet-break">
                        <div class="flex1 ri-paddingright20">
                            ...
                            <p>Fitur group kerja yang ada di dalam aplikasi Ayoohris, membantu karyawan lintas divisi bisa saling berkoordinasi dalam menyelesaikan beberapa tugas dalam sebuah project yang dikerjakan bersama. Dalam Batasan waktu tertentu ini akan lebih mudah untuk memonitor progress yang telah ditentukan berdasarkan kesepakatan bersama.</p>
                        </div>
                        <div class="flex1 ri-right">
                            <img src="img/icons/content3.svg" class="w-100 img-content" alt="">
                        </div>
                    </div>
                </div>
                <div class="new-col ri-padding20">
                    <div class="ri-flex tablet-break">
                        <div class="flex1 ri-paddingright20 push-content ct-right">
                            ...
                            <p>Tanpa perlu menggunakan kertas lagi, kita semua sudah ikut berkontribusi menyelamatkan bumi.</p>
                        </div>
                        <div class="flex1 ri-left pull-content">
                            <img src="img/icons/content4.svg" class="w-100 img-content" alt="">
                        </div>
                    </div>
                </div>
                <div class="new-col ri-padding20">
                    <div class="ri-flex tablet-break">
                        <div class="flex1 ri-paddingright20">
                            ...
                            <p>Pengaturan tugas, pengalihan tugas, serta penambahan tugas rutin harian karyawan operasional, bisa dilakukan menggunakan aplikasi ini. Tugas lebih jelas dan lekas tuntas.</p>
                        </div>
                        <div class="flex1 ri-right">
                            <img src="img/icons/content5.svg" class="w-100 img-content" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="ri-flex tablet-break ri-margintop40">
                        <div class="flex1 ri-marginright40 card-content ri-center">
                            <div class="card-service">
                                <div class="img-card">
                                    <img src="img/icons/advantages1.svg" alt="">
                                </div>
                                <div class="caption">
                                    <h1>Paperless</h1>
                                </div>
...
dikerjakan segera.</p>
                        ...
                        <div class="flex1 ri-marginright40 card-content ri-center">
                            <div class="card-service">
                                <div class="img-card">
                                    <img src="img/icons/advantages2.svg" alt="">
                                </div>
                                <div class="caption">
                                    <h1>Praktis dan sistematis</h1>
                                </div>
                                <p>Tanpa tatap muka, buat tugas dan pengalihan tugas instruksional bisa dilakukan kapan saja dan di mana saja. Begitu juga pelaporannya, bisa disampaikan saat itu juga.</p>
                            </div>
                        </div>
                        <div class="flex1 card-content ri-center">
                            <div class="card-service">
                                <div class="img-card">
                                    <img src="img/icons/advantages3.svg" alt="">
                                </div>
                                <div class="caption">
...
otomatis oleh Administrator melalui aplikasinya. </p>
                    ...
                    <div class="ri-flex tablet-break ri-margintop40">
                        <div class="flex1 ri-marginright40 card-content ri-center">
                            <div class="card-service">
                                <div class="img-card">
                                    <img src="img/icons/advantages4.svg" alt="">
                                </div>
                                <div class="caption">
                                    <h1>Efisensi waktu dan biaya</h1>
                                </div>
                                <p>segala informasi hasil kerja karyawan yang mendapatkan tugas instruksional, bisa ditelusuri kembali historinya secara lengkap dan detail.</p>
                            </div>
                        </div>
                        <div class="flex1 ri-marginright40 card-content ri-center">
                            <div class="card-service">
                                <div class="img-card">
                                    <img src="img/icons/advantages5.svg" alt="">
                                </div>
                                <div class="caption">
                                    <h1>Terintegrasi dengan sistem HRIS</h1>
                                </div>
                                <p>Performa hasil kerja karyawan bagian opersional menjadi catatan penting bagi tim HRD secara personal dan kontekstual.</p>
                            </div>
                        </div>
                        <div class="flex1 card-content ri-center">
                            <div class="card-service">
                                <div class="img-card">
                                    <img src="img/icons/advantages6.svg" alt="">
                                </div>
                                <div class="caption">
                                    <h1>Open REST API <span>(Term & Condition)</span></h1>
                                </div>
                                <p>Kami juga melayani perusahaan yang bekerja sama dengan perusahaan kami untuk mengintegrasikan aplikasi ini.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="inner-content ri-center">
                    ...
                    <div class="ri-block ri-margintop40 ri-marginbottom40">
                        <div class="ri-inlineblock ri-paddingright20">
                            <img src="img/clients/1.png" class="inline img-logo" alt="">
                        </div>
                        <div class="ri-inlineblock ri-paddingright20">
                            <img src="img/clients/2.png" class="inline img-logo" alt="">
                        </div>
                        <div class="ri-inlineblock ri-paddingright20">
                            <img src="img/clients/3.png" class="inline img-logo" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="ads-banner">
            ...
            <div class="right-btn-ads">
                <button class="ri-button btn btn-default srounded inline">KUNJUNGI</button>
            </div>
