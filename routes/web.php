...
Route::group(['middleware' => ['auth']], function () {
	...
	Route::get('/getCheckListEmployeeByUserId/{id}/{location}', 'Admin\CheckListController@getCheckListEmployeeByUserId');
	...
	Route::get('/filterChecklistProgressDate/{date}/{type}', 'Admin\CheckListController@filterChecklistProgressDate');
	...
	Route::put('location/{id}', 'Admin\LocationController@update');
	Route::delete('location/{id}', 'Admin\LocationController@delete');
	Route::get('getMenuLocation', 'Admin\LocationController@getLocation');
	
	//checklist_new
	Route::get('menu_checklist', 'Admin\MenuChecklistController@index');
	Route::post('menu_checklist', 'Admin\MenuChecklistController@store');
	Route::put('menu_checklist/{id}', 'Admin\MenuChecklistController@update');
	Route::delete('menu_checklist/{id}', 'Admin\MenuChecklistController@delete');
	Route::get('getMenuChecklist', 'Admin\MenuChecklistController@getMenuChecklist');
	
	//operTugas
	Route::get('operTugas', 'Admin\ChecklistController@operTugas');
});
