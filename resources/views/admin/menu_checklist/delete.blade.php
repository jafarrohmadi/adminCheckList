                ...
                <div
                    ...
                    <div class="ri2-block ri2-relative ri2-boxpad40 ri2-mobileboxpad20 ri2-box">
                        <div class="ri2-block ri2-relative ri2-font14 ri2-txblack3 ri2-marginbottom20">
                            <b class="deleteusername"></b> akan di hapus?
                        </div>
                        <input type="hidden" name="deleteuserid" id="deleteuserid">
                        <div class="ri2-block ri2-relative ri2-center">
                            <button
                                    class="noty-button-hapus modalhapususersave ri2-inlineblock ri2-bordernone ri2-borderradius2 ri2-boxpad7 ri2-paddingright15 ri2-paddingleft15 ri2-bgyellow1 ri2-txblack1 ri2-hovering ri2-font16 ri2-semibold ri2-pointer">
                                Hapus
                            </button>
                        </div>
                    </div>
