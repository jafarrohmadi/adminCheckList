...
@section('content')
    ...
    <div class="ri2-block ri2-relative ri2-boxpad20 ri2-box ri2-bgwhite2">
        <a class="modalbuatuseropen new-toolbarbutton ri2-inlineblock new-ocean-gradient ri2-font14 ri2-mobilefont12 ri2-semibold ri2-txwhite1 ri2-pointer ri2-hovering"><i
                    class="fas fa-plus-circle"></i> Buat CheckList</a>
    </div>
    ...
    @include('admin.menu_checklist.create')
    @include('admin.menu_checklist.edit')
    @include('admin.menu_checklist.delete')
@endsection
@section('js')
    <!--add js-->
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", '.modaleditusersave', function () {
            ...
            $.ajax({
                type: 'put',
                url: "{{url('/menu_checklist') }}/" + $('#editid').val(),
                data: {
                    '_token': "{{  csrf_token() }}",
                    'name': $("#editname").val(),
                },
        ...
        $(document).on("click", '.modalhapususersave', function () {
            ...
            $.ajax({
                type: 'delete',
                url: "{{url('/menu_checklist') }}/" + $('#deleteuserid').val(),
                data: {
                    '_token': "{{  csrf_token() }}",
                },
                success: function (data) {
