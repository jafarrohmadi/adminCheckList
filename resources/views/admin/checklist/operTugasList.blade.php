<div class="new-parent ri2-inlineblock ri2-fullwidth ri2-relative">
    @foreach($checkListOperTugas as $checkListOperTugases)
        <div class="modaleditopertugasopen ri2-floatleft new-onduty-list new-child ri2-vtop ri2-boxpad15 ri2-box ri2-borderradius5 ri2-borderfull1 ri2-borderwhite3 ri2-pointer"
            ...
            <div class="ri2-block ri2-relative ri2-center ri2-marginbottom10">
                <img src="{{ $checkListOperTugases->toUser['photo'] }}" class="ri2-circle ri2-vmid ri2-borderfull3 ri2-borderwhite5 new-user-mthumbnail">
            </div>
            ...
            <div class="ri2-block ri2-relative ri2-center ri2-txgrey1 ri2-font14">
                {{ $checkListOperTugases->location['name'] ?? '' }} <a class="ri2-relative ri2-inlineblock ri2-nowrap ri2-tooltip"><span class="ri2-tooltiptext ri2-normal ri2-linenormal">Operan dari {{ $checkListOperTugases->fromUser['name'] }}</span><i class="fas fa-exchange-alt ri2-rotate-45 ri2-txgreen1"></i></a>
            </div>
        </div>
    @endforeach
</div>
