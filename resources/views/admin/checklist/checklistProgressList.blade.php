...
<tr>
    ...
    <td>{{ $checkListProgres->location->name }}
        ...
        <a class="ri2-relative ri2-inlineblock ri2-nowrap ri2-tooltip">
            <span class="ri2-lefttooltiptext ri2-normal ri2-linenormal">Mengalih Tugaskan dari {{ $checkListProgres->checkListOperTugas->fromUser->name  ?? ''}}</span>
