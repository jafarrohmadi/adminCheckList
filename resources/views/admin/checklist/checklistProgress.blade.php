<!--modalcheklistprogress-->
<div class="modalchecklistprogress ri2-modal ri2-fixed ri2-fullwidth ri2-fullheight">
    <div class="ri2-table ri2-fullwidth ri2-fullheight ri2-relative">
        <div class="ri2-cell ri2-center ri2-vmid ri2-boxpad20 ri2-box">
            <div
                class="modalchecklistprogressback ri2-modal-back ri2-absolute ri2-fullwidth ri2-fullheight"></div>
            <div class="ri2-modal-content ri2-relative new-modal-content">
                <div
                    ...
                    <div
                        ...
                        <div class="ri2-block ri2-relative">
                            <div
                                class="ri2-block ri2-relative ri2-txgrey1 ri2-font14 ri2-marginbottom5">
                                Selesai <span id="activeCheckListProgress"></span> dari <span
                                    id="checkListAllProgress"></span> Tugas
                            </div>
                            <div
                                class="ri2-table ri2-relative ri2-fullwidth new-zebratable ri2-font16 ri2-txblack3">
                                <span id="checkListProgressAll"></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="ri2-block ri2-relative ri2-center">
                    <div
                        class="modalchecklistprogressclose ri2-inlineblock ri2-relative ri2-modal-close ri2-txwhite1 ri2-semibold ri2-font20 ri2-pointer ri2-linkhoveryellow1">
