<!--modal modaledituser-->
<div class="modaledituser ri2-modal ri2-fixed ri2-fullwidth ri2-fullheight">
    <div class="ri2-table ri2-fullwidth ri2-fullheight ri2-relative">
        <div class="ri2-cell ri2-center ri2-vmid ri2-boxpad20 ri2-box">
            <div class="modaledituserback ri2-modal-back ri2-absolute ri2-fullwidth ri2-fullheight"></div>
                ...
                <div
                    ...
                    <div class="ri2-block ri2-relative ri2-boxpad40 ri2-mobileboxpad20 ri2-box">
                        ...
                        <div class="ri2-block ri2-relative ri2-marginbottom20 ri2-left">
                            ...
                            <div class="ri2-block ri2-relative">
                                <input  style="margin-right: 300px;" type="text" name="phone_number" id="editphone_number"
                                       class="ri2-input40 ri2-paddingleft10 ri2-paddingright10 ri2-box ri2-bgwhite2 ri2-borderradius2 ri2-borderfull1 ri2-borderwhite5 ri2-fullwidth ri2-input-greyholder ri2-font14">
                            </div>
                        </div>
                        <div class="ri2-block ri2-relative ri2-marginbottom20 ri2-left">
...
{{--                            <div class="ri2-block ri2-relative">--}}
{{--                                <select--}}
{{--                                    class="basic-multiple ri2-block ri2-relative ri2-input40 ri2-input-greyholder ri2-box ri2-bgwhite4 ri2-fullwidth"--}}
{{--                                    name="access" id="editaccess">--}}
...
{{--                        </div>--}}
                        <div class="ri2-block ri2-relative ri2-left ri2-margintop20">
                            <button
                                class="noty-button modaleditusersave ri2-inlineblock ri2-bordernone ri2-borderradius2 ri2-boxpad7 ri2-paddingright15 ri2-paddingleft15 ri2-bgblue1 ri2-txwhite1 ri2-hovering ri2-font16 ri2-semibold ri2-pointer">
                                Simpan
                            </button>
                            <button
                                class="modaledituserclose ri2-inlineblock ri2-bordernone ri2-borderradius2 ri2-boxpad7 ri2-paddingright15 ri2-paddingleft15 ri2-bgwhite5 ri2-txblack3 ri2-hovering ri2-font16 ri2-semibold ri2-pointer">
                                Batal
                            </button>
                        </div>
                    </div>
                ...
                <div class="ri2-block ri2-relative ri2-center">
                    <div
                        class="modaledituserclose ri2-inlineblock ri2-relative ri2-modal-close ri2-txwhite1 ri2-semibold ri2-font18 ri2-pointer ri2-linkhoveryellow1">
